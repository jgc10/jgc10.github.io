...
<title>redirect | cyber@CIT</title>
...
<body class="bg-gradient-to-r from-slate-900 to-slate-800 font-mono text-white">
  ...
  <nav
    ...
    <div class="flex flex-col gap-1">
      <a href="http://localhost:1313/" class="text-4xl font-bold hover:text-sky-400 whitespace-nowrap">cyber@CIT</a>
      <p>Cybersecurity Club from the University of New Haven</p>
    </div>
  ...
  <div class="flex flex-col pt-8 gap-10">
    ...
    <div class="flex flex-col w-full gap-4">
      <h2 class="text-3xl max-sm:text-2xl font-bold">redirect</h2>
      
      <div class="flex flex-row flex-wrap max-md:gap-4 gap-10">
        <p>📅 Wednesday, Jan 1, 2025</p>
        <p>⏰ 00:00:00</p>
        
          <p>🔄 Wednesday, Jan 1, 2025 00:00:00</p>
    ...
    <a href='/tags/tag1'
    class="border border-sky-400 p-1 hover:bg-sky-400 focus:bg-sky-400 text-center">tag1</a>
  
    <a href='/tags/tag2'
    class="border border-sky-400 p-1 hover:bg-sky-400 focus:bg-sky-400 text-center">tag2</a>
